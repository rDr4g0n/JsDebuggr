...
# TODO - ST2 version
# TODO - turn off all the print statements

# BUG - // in strings incorrectly detected as comment
# BUG - disabling auto scanned breakpoints is unreliable
...
class ClassifyTest(sublime_plugin.TextCommand):

    def run(self, edit):
        classy = self.view.classify(self.view.sel()[0].a)
        print(self.view.word(classy))
